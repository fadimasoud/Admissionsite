...
function FormForm(props) {
  ...
  let CheckboxClick = (e) => {     
    if(e.target.checked){   
      formStore.Applicant[18]=e.target.value;    
      formStore.error = [];
    }else{
      formStore.Applicant[18]="";    
      formStore.error = [];
    }
    console.log(formStore.Applicant[18])
  };
  return (
    <div>      
                      ...
                      <ul id='gform_fields_17' className='gform_fields top_label form_sublabel_below description_below'>
                        ...
                        <div className="form-group">
                          <input className="form-control"
                            ...
                            autoComplete="on"
                            placeholder="first"
                            value={formStore.Applicant[2]}
                            aria-label='First name'
                            maxLength='50'
                            required
                            onChange={(e) => {
                              console.log(formStore.Applicant[2])
                              formStore.Applicant[2] = e.target.value;
                              formStore.error = [];
                            }}/>
                        </div> 
                        <div className="form-group">
                          <input className="form-control"
                            type="text"
                            placeholder="last"
                            value={formStore.Applicant[3]}
                            aria-label='Last name' 
                            maxLength='50'                                 
                            required
                            onChange={(e) => {
                              console.log(formStore.Applicant[3])
                              formStore.Applicant[3] = e.target.value;
                              formStore.error = [];
                            }}/>
                        </div>                             
                        </li>
                        <li id='field_17_3' className='gfield gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible' >
                          ...
                          <input className="form-control"
                            type="email"
                            placeholder="Email"
                            value={formStore.Applicant[4]}
                            aria-invalid="false"   
                            maxLength='255'                               
                            required
                            onChange={(e) => {
                              console.log(formStore.Applicant[4])
                              formStore.Applicant[4] = e.target.value;
                              formStore.error = [];
                            }}/>
                        </div>                              
                        </li>
                        ...
                        <div className="form-group">
                          <input className="form-control"
                            ...
                            value={formStore.Applicant[5]}
                            aria-invalid="false"
                            maxLength='40'                                  
                            required
                            onChange={(e) => {
                              console.log(formStore.Applicant[5])
                              formStore.Applicant[5] = e.target.value;
                              formStore.error = [];
                            }}/>
                        </div>
                        </li>
                        ...
                        <div className="form-group">
                          <input className="form-control"
                            ...
                            value={formStore.Applicant[6]}                                  
                            maxLength='8'                                  
                            required
                            onChange={(e) => {
                              console.log(formStore.Applicant[6])
                              formStore.Applicant[6] = e.target.value;
                              formStore.error = [];
                            }}/>
                        </div> 
                        </li>
                         <li id='field_17_7' className='gfield gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible' >
                          ...
                          <div className="form-group">                                
                            <select className="form-control"                                    
                              name="Gender:"
                              value={formStore.Applicant[7]}                                    
                              aria-invalid="false"                                 
                              maxLength='8'                                                                     
                              required
                              onChange={(e) => {
                                console.log(formStore.Applicant[7])
                                formStore.Applicant[7] = e.target.value;
                                formStore.error = [];
                              }}
                              >
                        ...
                        <li id='field_17_21' className='gfield gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible' >
                          ...
                          <div className="form-group">                                
                            <select className="form-control"                                    
                              name="T-Shirt Size"
                              value={formStore.Applicant[8]}                                    
                              aria-invalid="false"                                 
                              maxLength='4'                                                                     
                              required
                              onChange={(e) => {
                                console.log(formStore.Applicant[8])
                                formStore.Applicant[8] = e.target.value;
                                formStore.error = [];
                              }}
                              >
                        ...
                        <li id='field_17_8' className='gfield gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible' >
                          ...
                          <input className="form-control"
                            ...
                            value={formStore.Applicant[9]}                                   
                            maxLength='255'                                 
                            required
                            onChange={(e) => {
                              console.log(formStore.Applicant[9])
                              formStore.Applicant[9] = e.target.value;
                              formStore.error = [];
                            }}/>
                          </div>                                   
                          ...
                          <input className="form-control"
                            ...
                            value={formStore.Applicant[10]}                                   
                            maxLength='255'                                 
                            required
                            onChange={(e) => {
                              console.log(formStore.Applicant[10])
                              formStore.Applicant[10] = e.target.value;
                              formStore.error = [];
                            }}/>
                          </div>                                    
                          ...
                          <input className="form-control"
                            ...
                            value={formStore.Applicant[11]}                                   
                            maxLength='40'                                 
                            required
                            onChange={(e) => {
                              console.log(formStore.Applicant[11])
                              formStore.Applicant[11] = e.target.value;
                              formStore.error = [];
                            }}/>
                          </div>                                    
                          ...
                          <select className="form-control"                                    
                            ...
                            required
                            onChange={(e) => {
                              console.log(formStore.[12])
                              formStore.[12] = e.target.value;
                              formStore.error = [];
                            }}
                            >
                            <option value='' ></option>
                        ...
                        <select className="form-control"                                    
                          ...
                          value={formStore.Applicant[13]}                                    
                          aria-invalid="false"                                 
                          maxLength='255'                                                                  
                          required
                          onChange={(e) => {
                            console.log(formStore.Applicant[13])
                            formStore.Applicant[13] = e.target.value;
                            formStore.error = [];
                          }}
                          >
                        ...
                        <input className="form-control"
                          ...
                          value={formStore.Applicant[14]}                                   
                          aria-invalid="false"
                          maxLength='255'                                 
                          required
                          onChange={(e) => {
                            console.log(formStore.Applicant[14])
                            formStore.Applicant[14] = e.target.value;
                            formStore.error = [];
                          }}/>
                        </div>
                        </li>
                        ...
                        <input className="form-control"
                          type="text"
                          placeholder="Major:"
                          value={formStore.Applicant[15]}                                   
                          aria-invalid="false"
                          maxLength='255'                                 
                          required
                          onChange={(e) => {
                            console.log(formStore.Applicant[15])
                            formStore.Applicant[15] = e.target.value;
                            formStore.error = [];
                          }}/>
                        </div>
                        </li>
                        ...
                        <textarea className="form-control"
                          ...
                          value={formStore.Applicant[16]}                                   
                          aria-invalid="false"
                          rows='10'
                          cols='50'
                          onChange={(e) => {
                            console.log(formStore.Applicant[16])
                            formStore.Applicant[16] = e.target.value;
                            formStore.error = [];
                          }}/>
                        </div>
                        </li>
                        ...
                        <input className="form-control"
                          ...
                          value={formStore.Applicant[17]}                                   
                          aria-invalid="false"
                          maxLength='255'
                          onChange={(e) => {
                            console.log(formStore.Applicant[17])
                            formStore.Applicant[17] = e.target.value;
                            formStore.error = [];
                          }}/>
                        </div>                               
                        </li>
                        ...
                        <textarea className="form-control"
                          ...
                          value={formStore.Applicant[19]}                                   
                          aria-invalid="false"
                          rows='10'
                          cols='50'
                          required
                          onChange={(e) => {
                            console.log(formStore.Applicant[19])
                            formStore.Applicant[19] = e.target.value;
                            formStore.error = [];
                          }}/>
                        </div>
                        </li>
                        ...
                        <textarea className="form-control"
                          ...
                          value={formStore.Applicant[20]}                                   
                          aria-invalid="false"
                          rows='10'
                          cols='50'
                          required
                          onChange={(e) => {
                            console.log(formStore.Applicant[20])
                            formStore.Applicant[20] = e.target.value;
                            formStore.error = [];
                          }}/>
                        </div>                                
                        </li>
                          ...
                          <div id='gform_multifile_upload_17_19' data-settings='{&quot;runtimes&quot;:&quot;html5,flash,html4&quot;,&quot;browse_button&quot;:&quot;gform_browse_button_17_19&quot;,&quot;container&quot;:&quot;gform_multifile_upload_17_19&quot;,&quot;drop_element&quot;:&quot;gform_drag_drop_area_17_19&quot;,&quot;filelist&quot;:&quot;gform_preview_17_19&quot;,&quot;unique_names&quot;:true,&quot;file_data_name&quot;:&quot;file&quot;,&quot;url&quot;:&quot;http:\/\/www.joincoded.com\/?gf_page=ab6f485d25ddf8f&quot;,&quot;flash_swf_url&quot;:&quot;http:\/\/www.joincoded.com\/wp-includes\/js\/plupload\/plupload.flash.swf&quot;,&quot;silverlight_xap_url&quot;:&quot;http:\/\/www.joincoded.com\/wp-includes\/js\/plupload\/plupload.silverlight.xap&quot;,&quot;filters&quot;:{&quot;mime_types&quot;:[{&quot;title&quot;:&quot;Allowed Files&quot;,&quot;extensions&quot;:&quot;jpg,png,jpeg,pdf&quot;}],&quot;max_file_size&quot;:&quot;4194304b&quot;},&quot;multipart&quot;:true,&quot;urlstream_upload&quot;:false,&quot;multipart_params&quot;:{&quot;form_id&quot;:17,&quot;field_id&quot;:19},&quot;gf_vars&quot;:{&quot;max_files&quot;:&quot;3&quot;,&quot;message_id&quot;:&quot;gform_multifile_messages_17_19&quot;,&quot;disallowed_extensions&quot;:[&quot;php&quot;,&quot;asp&quot;,&quot;aspx&quot;,&quot;cmd&quot;,&quot;csh&quot;,&quot;bat&quot;,&quot;html&quot;,&quot;htm&quot;,&quot;hta&quot;,&quot;jar&quot;,&quot;exe&quot;,&quot;com&quot;,&quot;js&quot;,&quot;lnk&quot;,&quot;htaccess&quot;,&quot;phtml&quot;,&quot;ps1&quot;,&quot;ps2&quot;,&quot;php3&quot;,&quot;php4&quot;,&quot;php5&quot;,&quot;php6&quot;,&quot;py&quot;,&quot;rb&quot;,&quot;tmp&quot;]}}' className='gform_fileupload_multifile'>
                            <div id='gform_drag_drop_area_17_19' className='gform_drop_area'>                              
                              <input
                                type="file"                                  
                                onChange={(file) => {                                              
                                  formStore.Applicant[21]=file.target.files[0];
                                  formStore.error = [];
                                  console.log(formStore.Applicant[21])
                                }}                                         
                              />                                                                          
                              </div>
                              </div>                                 
                        ...
                        <li id='field_17_14' className='gfield field_sublabel_below field_description_below gfield_visibility_visible' >
                         ...
                         <input
                            type="file" 
                            onChange={(file) => {                                              
                              formStore.Applicant[22]=file.target.files[0];
                              formStore.error = [];
                              console.log(formStore.Applicant[22])
                            }}                                        
                          /> 
